...
namespace LoveAlgo.Schedule
{
    ...
    public static class ScheduleTable
    {
        ...
        static void RegisterDefaults()
        {
            ...
            Add(ScheduleType.Exercise_C, "운동 C", "(기획 추가 예정)", 0, 1, 0, 0, 1, 3);
            Add(ScheduleType.Study_D, "공부 D", "(기획 추가 예정)", 0, 0, 3, 0, 0, 5);
            Add(ScheduleType.Study_E, "공부 E", "(기획 추가 예정)", 0, 0, 2, 0, 0, 3);
            Add(ScheduleType.Study_F, "공부 F", "(기획 추가 예정)", 0, 0, 1, 1, 0, 2);
        }
        #endregion
    }
}
