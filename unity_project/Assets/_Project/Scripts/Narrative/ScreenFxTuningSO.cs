...
{
    /// <summary>
    /// 스크린 FX 연출 동결 수치 Definition SO(ADR-012: 코드 매직넘버 금지). 페이드/플래시 기본 시간(초).
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "ScreenFxTuning", menuName = "LoveAlgo/Screen FX Tuning")]
    public class ScreenFxTuningSO : ScriptableObject
    {
